...
$sql = "INSERT INTO `offrproduct` (`image`, `price`, `details`, `brand`, `color`,`storeid`, `cname`,`cust_type`,`subcat`, `offers`,`size`,`delamnt`,`available`,`storename`,`name`) VALUES ('$target_file','$price','$detail','$brand','$color','$storeid','$cname','$cust_type','$subcat','$offer','$size','$delamnt','$avail','$storename','$name');";
...
<div>
<h1>UPLOAD PRODUCTS for OFFER</h1>
</div>
<div class="datas">
